![Current Release](https://img.shields.io/github/release/mtrab/dk_fuelprices/all.svg?style=plastic)
![Github All Releases](https://img.shields.io/github/downloads/mtrab/dk_fuelprices/total.svg?style=plastic)
...
*   Unpack the release and copy the custom\_components/dk_fuelprices directory into the custom\_components directory of your Home Assistant installation.
*   Restart Home Assistant.
...
[![](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=dk_fuelprices)
